        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SwellDirection = table.Column<string>(nullable: false),
                    WindDirection = table.Column<string>(nullable: false),
                    WindStrength = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_dbo.WaveConditions", x => x.SurfProfileID);
                });
